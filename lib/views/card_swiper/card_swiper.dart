...
import 'package:all/views/card_swiper/src/config.dart';
import 'package:all/views/card_swiper/src/example_custom.dart';
import 'package:all/views/card_swiper/src/example_swiper_in_scrollview.dart';
