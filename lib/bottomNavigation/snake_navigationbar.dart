...
class snake_navigationbar extends StatelessWidget {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: SnakeNavigationBar.color(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.clean_hands), label: 'calendar'),
